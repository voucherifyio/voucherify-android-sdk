...
import pl.rspective.voucherify.android.client.model.Discount;
...
public class VoucherifyUtils {
    ...
    public static BigDecimal calculatePrice(BigDecimal basePrice, VoucherResponse voucher, BigDecimal unitPrice) {
    ...
    public static BigDecimal calculateDiscount(BigDecimal basePrice, VoucherResponse voucher, BigDecimal unitPrice) {
        Discount discount = voucher.getDiscount();
