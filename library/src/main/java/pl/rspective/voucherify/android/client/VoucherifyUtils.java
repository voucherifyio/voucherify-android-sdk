...
public class VoucherifyUtils {
    ...
    public static BigDecimal calculatePrice(BigDecimal basePrice, VoucherResponse voucher) {
    ...
    public static BigDecimal calculateDiscount(BigDecimal basePrice, VoucherResponse voucher) {
        BigDecimal discount = valueOf(voucher.getDiscount() / 100.0);
