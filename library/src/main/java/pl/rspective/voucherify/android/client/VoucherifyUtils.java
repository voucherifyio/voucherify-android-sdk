...
import pl.rspective.voucherify.android.client.exception.VoucherifyException;
import pl.rspective.voucherify.android.client.model.DiscountType;
...
public class VoucherifyUtils {
    ...
    public static BigDecimal calculatePrice(BigDecimal basePrice, VoucherResponse voucher) throws VoucherifyException {
    ...
    public static BigDecimal calculateDiscount(BigDecimal basePrice, VoucherResponse voucher) throws VoucherifyException {
        BigDecimal discount = valueOf(voucher.getDiscount() / 100.0);
